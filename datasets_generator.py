...
CLASS = ["voip", "video", "file transfer", "chat", "browsing"]
TEST_SIZE = 0.1
DATASET_DIR = "../datasets/"

VPN_TYPES = {
    "reg": glob.glob("E:/Python/FlowPic-main/FlowPic-main/raw_csvs/classes/**/reg/*.npy"),
    "vpn": glob.glob("E:/Python/FlowPic-main/FlowPic-main/raw_csvs/classes/**/vpn/*.npy"),
    "tor": glob.glob("E:/Python/FlowPic-main/FlowPic-main/raw_csvs/classes/**/tor/*.npy")
}
